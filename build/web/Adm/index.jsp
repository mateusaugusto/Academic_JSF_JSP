<%-- 
    Document   : index
    Created on : May 31, 2014, 3:52:17 PM
    Author     : modesto
--%>
                                        ...
                                        <div id="wrapper">
                                            ...
                                            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                                                ...
                                                <div class="navbar-header">
                                                    ...
                                                    <a class="navbar-brand" href="index.jsp">SGA</a>
                                                </div>
                                            ...
                                            <div id="page-wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h1>Bem vido  <small>Administrador</small></h1>
                                                        <ol class="breadcrumb">
                                                            <li class="active"><i class="fa fa-dashboard"></i> Home</li>
                                                        </ol>
                                                        <div class="alert alert- alert-info">
                                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                            Gerencie totalmente o cadastro de Curso, Matérias, Professores e Aluno, aproveite ao máximo o que o painel SGA tem a oferecer. 
                                                        </div>
                                                    </div>
                                                </div><!-- /.row -->
                                                        ...
                                                        <div class="panel panel-danger">
                                                            <div class="panel-heading">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-6 text-right">
                                                                        <h2> <p class="announcement-text">Prof.</p></h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <a href="cad_professores.jsp">
                                                                <div class="panel-footer announcement-bottom">
                                                                    <div class="row">
                                                                        <div class="col-xs-6">
                                                                            Gerencie</div>
